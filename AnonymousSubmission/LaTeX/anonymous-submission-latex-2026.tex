...
\begin{enumerate}
\item \textbf{Global Alignment Score (GAS)}: Measures overall global thematic alignment using full-text embeddings.
\item \textbf{Local Alignment Score (LAS)}: Assesses fine-grained local semantic alignment between chunks.
