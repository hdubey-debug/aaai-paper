...
To capture global thematic alignment, VCS first encodes each full description—$T_{ref}$ and $T_{gen}$—into a single, $D$-dimensional vector via NV-Embed-v2. The GAS computes cosine similarity between these global vectors:
