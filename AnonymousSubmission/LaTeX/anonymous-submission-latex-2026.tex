...
VCS computes global thematic alignment to capture overall semantic correspondence between reference and generated descriptions. Given input texts $T_{ref}$ and $T_{gen}$, we encode each description into embeddings $\mathbf{E}_{ref}, \mathbf{E}_{gen} \in \mathbb{R}^{D}$ using NV-Embed-v2. GAS computes their cosine similarity:
